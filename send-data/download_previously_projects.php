...
$sql = "SELECT project_id FROM previously_project";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $project['pdf_path'] = "http://192.168.206.24/send-data/previously_projects_available/previously_projects_available.pdf?token=$token&timestamp=$timestamp";
            $projects[] = $project;
        }
    } else {
        // No projects found
